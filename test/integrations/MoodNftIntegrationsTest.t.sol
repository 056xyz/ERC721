...
contract MoodNftIntegrationsTest is Test {
    ...
    string public constant HAPPY_SVG_IMAGE_URI =
        "data:image/svg+xml;base64,PHN2ZyB2aWV3Qm94PSIwIDAgMjAwIDIwMCIgd2lkdGg9IjQwMCIgIGhlaWdodD0iNDAwIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmc ";
    ...
    function testFlipTokenToSad() public {
        ...
        assertEq(keccak256(abi.encodePacked(moodNft.tokenURI(1))), keccak256(abi.encodePacked(SAD_SVG_URI)));
    }
}
